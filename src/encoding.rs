...
pub mod hash_map {
    ...
    #[inline]
    pub fn encode<K, V, S, B, KE, KL, VE, VL>(
        key_encode: KE,
        key_encoded_len: KL,
        val_encode: VE,
        val_encoded_len: VL,
    ...
    /// Generic protobuf map encode function.
    #[inline]
    pub fn encoded_len<K, V, S, KL, VL>(
        key_encoded_len: KL,
        val_encoded_len: VL,
        tag: u32,
        values: &HashMap<K, V, S>,
    ...
    /// than 0 in proto2.
    #[inline]
    pub fn encode_with_default<K, V, S, B, KE, KL, VE, VL>(
        key_encode: KE,
        key_encoded_len: KL,
        val_encode: VE,
        val_encoded_len: VL,
    ...
    /// than 0 in proto2.
    #[inline]
    pub fn merge_with_default<K, V, S, B, KM, VM>(
        key_merge: KM,
        val_merge: VM,
        val_default: V,
        values: &mut HashMap<K, V, S>,
    ...
    /// than 0 in proto2.
    #[inline]
    pub fn encoded_len_with_default<K, V, S, KL, VL>(
        key_encoded_len: KL,
        val_encoded_len: VL,
        val_default: &V,
        tag: u32,
