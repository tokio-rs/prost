//! Translation of
//! [descriptor.proto v3.2.0](https://github.com/google/protobuf/blob/v3.2.0/src/google/protobuf/descriptor.proto)
//! to Rust.
...
pub mod field_descriptor_proto {
    #[repr(u8)]
    #[derive(Clone, Copy, Debug, Enumeration, PartialEq)]
    pub enum Type {
