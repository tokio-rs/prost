...
impl Field {
    ...
    pub fn encode(&self, ident: TokenStream) -> TokenStream {
        ...
        match self.label {
            ...
            Label::Required => quote! {
                ::prost::encoding::group::encode(#tag, #field, buf);
            },
    ...
    pub fn encoded_len(&self, ident: TokenStream) -> TokenStream {
        ...
        match self.label {
            Label::Optional => quote! {
                (#field).as_ref().map_or(0, |msg| ::prost::encoding::group::encoded_len(#tag, msg))
            },
            Label::Required => quote! {
                ::prost::encoding::group::encoded_len(#tag, #field)
            },
            Label::Repeated => quote! {
                ::prost::encoding::group::encoded_len_repeated(#tag, #field)
            },
        }
    }
