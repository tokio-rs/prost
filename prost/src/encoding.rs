...
impl sealed_string::StringAdapter for Arc<str> {
    ...
    fn replace_with(&mut self, mut buf: impl Buf) -> Result<(), DecodeError> {
        ...
        // Zero initialize, so that we can safely create a slice of this data.
        ...
        // filled in.
        let arc = unsafe {
            buf.copy_to_slice(core::slice::from_raw_parts_mut(
