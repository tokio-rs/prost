...
mod test {
    ...
    write_invalid_test!(invalid_color, shirt, ( {
        shirt.a_color = shirt.a_color[1..].to_string();
    }));
    write_invalid_test!(invalid_inner_size_0, shirt, ( {
        shirt.size = 0;
    }));
    write_invalid_test!(over_max_inner_size, shirt, ( {
        shirt.size = 999;
    }));
    write_invalid_test!(invalid_outer_size_0, shirt, ( {
        shirt.size_outer = 0;
    }));
    write_invalid_test!(over_max_outer_size, shirt, ( {
        shirt.size_outer = 999;
    }));
    write_invalid_test!(none_option, shirt, ( {
        shirt.option = None;
    }));
    write_invalid_test!(none_oneof, shirt, ( {
