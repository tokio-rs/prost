...
pub struct FieldDescriptorProto {
    ...
    #[prost(string, optional, tag = "2")]
    pub extendee: ::core::option::Option<String>,
...
pub struct FileOptions {
    ...
    /// domain names.
    #[prost(string, optional, tag = "1")]
    pub java_package: ::core::option::Option<String>,
    ...
    pub java_outer_classname: ::core::option::Option<String>,
    ...
    pub go_package: ::core::option::Option<String>,
    ...
    pub objc_class_prefix: ::core::option::Option<String>,
    /// Namespace for generated classes; defaults to the package.
    #[prost(string, optional, tag = "37")]
    pub csharp_namespace: ::core::option::Option<String>,
    /// By default Swift generators will take the proto package and CamelCase it
    /// replacing '.' with underscore and use that to prefix the types/symbols
    /// defined. When this options is provided, they will use this value instead
    /// to prefix the types/symbols defined.
    #[prost(string, optional, tag = "39")]
    pub swift_prefix: ::core::option::Option<String>,
    /// Sets the php class prefix which is prepended to all php generated classes
    /// from this .proto. Default is empty.
    #[prost(string, optional, tag = "40")]
    pub php_class_prefix: ::core::option::Option<String>,
    /// Use this option to change the namespace of php generated classes. Default
    /// is empty. When this option is empty, the package name will be used for
    /// determining the namespace.
    #[prost(string, optional, tag = "41")]
    pub php_namespace: ::core::option::Option<String>,
    /// Use this option to change the namespace of php generated metadata classes.
    /// Default is empty. When this option is empty, the proto file name will be
    /// used for determining the namespace.
    #[prost(string, optional, tag = "44")]
    pub php_metadata_namespace: ::core::option::Option<String>,
    /// Use this option to change the package of ruby generated classes. Default
    /// is empty. When this option is not set, the package name will be used for
    /// determining the ruby package.
    #[prost(string, optional, tag = "45")]
    pub ruby_package: ::core::option::Option<String>,
...
pub struct UninterpretedOption {
    ...
    #[prost(string, optional, tag = "3")]
    pub identifier_value: ::core::option::Option<String>,
    ...
    pub string_value: ::core::option::Option<Vec<u8>>,
    #[prost(string, optional, tag = "8")]
    pub aggregate_value: ::core::option::Option<String>,
}
...
pub mod source_code_info {
    ...
    pub struct Location {
        ...
        #[prost(string, optional, tag = "3")]
        pub leading_comments: ::core::option::Option<String>,
        #[prost(string, optional, tag = "4")]
        pub trailing_comments: ::core::option::Option<String>,
...
pub mod generated_code_info {
    ...
    pub struct Annotation {
        ...
        #[prost(string, optional, tag = "2")]
        pub source_file: ::core::option::Option<String>,
